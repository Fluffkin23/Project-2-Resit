    ...
    while ($row = fetch_array($query))
    {
        $product = <<<DELIMETER
            <tr>
                ...
                <td> <a class='btn btn-danger' href = "delete_service.php?delete&id={$row['SERVICE_ID']}"><span class='glyphicon glyphicon-remove'></span></a></td>
                <td> <a class='btn btn-danger' href = "edit_service.php?edit&id={$row['SERVICE_ID']}"><span class='glyphicon glyphicon-edit'></span></a></td>
